...
package net.bretti.openapi.route.definition.locator.core.filter;
...
@FunctionalInterface
public interface OpenApiRouteDefinitionFilter {
    boolean test(RouteDefinition routeDefinition,
