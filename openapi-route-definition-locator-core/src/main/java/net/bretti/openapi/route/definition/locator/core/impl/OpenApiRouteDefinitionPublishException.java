...
public class OpenApiRouteDefinitionPublishException extends RuntimeException {
    public OpenApiRouteDefinitionPublishException(String message, Throwable cause) {
        super(message, cause);
    }
}
