...
Gradle Kotlin DSL
```kotlin
implementation(platform("net.bretti.openapi-route-definition-locator:openapi-route-definition-locator-bom:0.2.0"))
...
See [Converting Durations](https://docs.spring.io/spring-boot/docs/2.6.8/reference/html/features.html#features.external-config.typesafe-configuration-properties.conversion.durations)
...
If you have
[enabled the Prometheus endpoint](https://docs.spring.io/spring-boot/docs/2.6.8/reference/html/actuator.html#actuator.metrics.export.prometheus)
