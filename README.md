...
<dependencyManagement>
   <dependencies>
      <dependency>
         ...
         <version>0.6.7-sc-2022.0</version>
         <type>pom</type>
         <scope>import</scope>
      </dependency>
   </dependencies>
...
Gradle Kotlin DSL
```kotlin
implementation(platform("net.bretti.openapi-route-definition-locator:openapi-route-definition-locator-bom:0.6.7-sc-2022.0"))
...
[ResourceLoader](https://docs.spring.io/spring-framework/docs/6.0.16/reference/html/core.html#resources-resourceloader).
