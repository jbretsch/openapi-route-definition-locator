...
@Component
class EnvironmentRouteDefinitionFilter implements OpenApiRouteDefinitionFilter {
    @Override
    boolean test(
        ...
        Object apiOperationEnv = ObjectUtils.firstNonNull(openApiOperationExtensions['x-environment'], openApiGlobalExtensions['x-environment'])
        return apiOperationEnv == null || apiOperationEnv == "dev"
    }
}
